...
},{"core-js/fn/regexp/escape":2,"core-js/shim":325,"regenerator-runtime/runtime":328}],2:[function(require,module,exports){
...
"use strict";require("babel-polyfill");var _window=require("window.ipfs-fallback"),_window2=_interopRequireDefault(_window),_queryString=require("query-string"),_queryString2=_interopRequireDefault(_queryString);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _asyncToGenerator(e){return function(){var t=e.apply(this,arguments);return new Promise(function(e,n){return function r(a,i){try{var o=t[a](i),d=o.value}catch(e){return void n(e)}if(!o.done)return Promise.resolve(d).then(function(e){r("next",e)},function(e){r("throw",e)});e(d)}("next")})}}var buildError=function(e){document.getElementById("main").appendChild(document.createTextNode(e))},buildPage=function(e){var t=document.getElementById("main"),n=document.createElement("div");n.style.backgroundImage="url('"+e.pic.url+"')",n.className="pic",t.appendChild(n);var r=document.createElement("div");r.className="profile";var a=document.createElement("h1"),i=document.createTextNode(e.name.first+" "+e.name.last);a.appendChild(i),r.appendChild(a);var o=e.work[0],d=document.createElement("h2"),c=document.createElement("a");c.href=o.url,c.appendChild(document.createTextNode(o.employer)),d.appendChild(document.createTextNode(o.title+" at ")),d.appendChild(c),r.appendChild(d);var l=document.createElement("div"),u=document.createTextNode(""+e.bio);l.className="bio",l.appendChild(u),r.appendChild(l);var s=document.createElement("div");s.id="social";var p=!0,m=!1,f=void 0;try{for(var v,h=e.social[Symbol.iterator]();!(p=(v=h.next()).done);p=!0){var y=v.value,g=document.createElement("a");g.className="social",g.href=y.url;var w=document.createElement("i");"website"===y.service?w.className="fas fa-globe":w.className="fab fa-"+y.service,g.appendChild(w),s.appendChild(g)}}catch(e){m=!0,f=e}finally{try{!p&&h.return&&h.return()}finally{if(m)throw f}}r.appendChild(s),t.appendChild(r)},setup=function(){var e=_asyncToGenerator(regeneratorRuntime.mark(function e(){var t,n,r,a,i,o,d,c;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,(0,_window2.default)();case 3:return t=e.sent,n=_queryString2.default.parse(location.search),e.next=7,t.id();case 7:return r=e.sent,a=n.pid?n.pid:r.id,console.log("running "+r.agentVersion+" with ID "+r.id),e.next=12,t.name.resolve("/ipns/"+a);case 12:return i=e.sent,e.next=15,t.files.get(i+"/json");case 15:o=e.sent,d=String.fromCharCode.apply(null,o[0].content),c=JSON.parse(d),buildPage(c),e.next=25;break;case 21:e.prev=21,e.t0=e.catch(0),console.log(e.t0),buildError(e.t0);case 25:case"end":return e.stop()}},e,void 0,[[0,21]])}));return function(){return e.apply(this,arguments)}}();setup();

},{"babel-polyfill":1,"query-string":327,"window.ipfs-fallback":330}]},{},[331]);
